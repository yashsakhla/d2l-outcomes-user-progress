...
D2L.PolymerBehaviors.OutcomesUserProgress.LocalizeBehavior.LangJaBehavior = {
	ja: {
		'bigTrendAttemptsScreenReaderString': '{numAttempts, plural, one {試行 {attemptNames}} other {試行 {attemptNames} と {lastAttemptName}}}',
		'bigTrendAttemptsTooltipString': '{numAttempts, plural, one {回の試行} other {回の試行}} {attemptNames}',
		'close': '閉じる',
		'evidence': '証明',
		'headingDate': '日付',
		'headingEvidence': '証明の名前',
		'headingLoa': '達成レベル',
		'miniTrendAttemptsTooltipString': '{numAttempts, plural, one {回の試行} other {回の試行}} {attemptNames}',
		'miniTrendScreenReaderText': '{numAssessed} {numAssessed, plural, one {回} other {回}}評価済み: {levelNames}',
