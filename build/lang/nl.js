...
D2L.PolymerBehaviors.OutcomesUserProgress.LocalizeBehavior.LangNlBehavior = {
	nl: {
		'bigTrendAttemptsScreenReaderString': '{numAttempts, plural, one {Poging {attemptNames}} other {Pogingen {attemptNames} en {lastAttemptName}}}',
		'bigTrendAttemptsTooltipString': '{numAttempts, plural, one {Poging} other {Pogingen}} {attemptNames}',
		'close': 'Sluiten',
		'evidence': 'Bewijs',
		'headingDate': 'Datum',
		'headingEvidence': 'Naam bewijs',
		'headingLoa': 'Niveau van de resultaten',
		'miniTrendAttemptsTooltipString': '{numAttempts, plural, one {Poging} other {Pogingen}} {attemptNames}',
		'miniTrendScreenReaderText': 'Beoordeeld {numAssessed} {numAssessed, plural, one {time} other {times}}: {levelNames}',
