...
D2L.PolymerBehaviors.OutcomesUserProgress.LocalizeBehavior.LangZhTwBehavior = {
	zhTw: {
		'bigTrendAttemptsScreenReaderString': '{numAttempts, plural, one {次嘗試 {attemptNames}} other {次嘗試 {attemptNames} 與 {lastAttemptName}}}',
		'bigTrendAttemptsTooltipString': '{numAttempts, plural, one {次嘗試} other {次嘗試}} {attemptNames}',
		'close': '關閉',
		'evidence': '證明',
		'headingDate': '日期',
		'headingEvidence': '證明名稱',
		'headingLoa': '達成層級',
		'miniTrendAttemptsTooltipString': '{numAttempts, plural, one {次嘗試} other {次嘗試}} {attemptNames}',
		'miniTrendScreenReaderText': '已評量 {numAssessed} {numAssessed, plural, one {次} other {次}}：{levelNames}',
